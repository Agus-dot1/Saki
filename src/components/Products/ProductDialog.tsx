...
const ProductDialog: React.FC<ProductDialogProps> = ({ product, onClose }) => {
  ...
  return (
    <motion.div 
      className="fixed inset-0 z-50 flex items-center justify-center min-w-full min-h-screen p-2 overflow-hidden p-80 sm:p-4 backdrop-blur-sm bg-black/70"
      ...
      >
        ...
        <div className="flex flex-col h-full lg:flex-row">
          ...
          <div className="relative flex items-center justify-center p-2 bg-gradient-to-br lg:w-1/2 from-secondary/30 to-secondary/60 sm:p-6">
            ...
            {stockStatus && (
              <motion.div 
                className={`absolute top-4 left-4 px-4 py-2 rounded-full text-sm font-medium border ${stockStatus.color} backdrop-blur-sm shadow`}
          ...
          <motion.div 
            ...
            animate="visible"
          >
            <div className="flex-1 p-4 overflow-y-auto sm:p-8 lg:p-10">
              {/* Product Header */}
              <motion.div className="mb-6 sm:mb-8" variants={itemVariants}>
                <div className="flex items-center mb-2 space-x-2 sm:mb-3">
                ...
                <h2 
                  ...
                  className="mb-2 text-2xl font-light leading-tight sm:mb-4 sm:text-3xl lg:text-4xl text-primary"
                >
                  {product.name}
                </h2>
                <div className="flex items-baseline mb-4 space-x-2 sm:mb-6 sm:space-x-4">
                  <span className="text-2xl font-medium sm:text-4xl text-accent">
                    ${product.price.toFixed(2)}
                  </span>
                  <span className="text-base line-through sm:text-lg text-content">
                    ${(product.price * 1.2).toFixed(2)}
                  </span>
                  <span className="px-2 py-1 text-xs font-medium rounded-full sm:px-3 sm:text-sm bg-accent/10 text-accent">
                    17% OFF
                  </span>
                </div>
                <p className="text-base leading-relaxed sm:text-lg text-content">
              ...
              >
                <div className="text-center">
                  <Shield className="w-6 h-6 mx-auto mb-1 sm:w-8 sm:h-8 sm:mb-2 text-accent" />
                  <p className="text-xs font-medium sm:text-sm text-primary">100% Natural</p>
                </div>
                <div className="text-center">
                  <Truck className="w-6 h-6 mx-auto mb-1 sm:w-8 sm:h-8 sm:mb-2 text-accent" />
                  <p className="text-xs font-medium sm:text-sm text-primary">Envío Gratis</p>
                </div>
                <div className="text-center">
                  <Star className="w-6 h-6 mx-auto mb-1 sm:w-8 sm:h-8 sm:mb-2 text-accent" />
                ...
                <div className="flex items-center space-x-2 sm:space-x-4">
                  <div className="flex items-center overflow-hidden border rounded-lg border-secondary">
                    <button
                      ...
                      className="px-3 py-2 transition-colors sm:px-4 sm:py-3 hover:bg-secondary/50"
                      disabled={selectedQuantity <= 1}
                    >
                      -
                    </button>
                    <span className="px-4 sm:px-6 py-2 sm:py-3 bg-secondary/30 font-medium min-w-[40px] sm:min-w-[60px] text-center">
                      {selectedQuantity}
                    </span>
                    <button
                  ...
                  <span className="text-sm text-content sm:text-base">
                ...
                <div className="flex p-1 mb-4 space-x-1 rounded-lg sm:mb-6 bg-secondary/30">
                  {[
                    ...
                    <button
                      ...
                      className={`flex-1 py-2 sm:py-3 px-2 sm:px-4 rounded-md text-xs sm:text-sm font-medium transition-all duration-200 ${
                        activeTab === tab.id
            ...
            >
              <div className="flex flex-col gap-3 sm:gap-4 sm:flex-row">
                <motion.button 
                  ...
                  className="flex-1 bg-accent text-white py-3 sm:py-4 px-6 sm:px-8 rounded-xl flex items-center justify-center space-x-2 sm:space-x-3 hover:bg-supporting transition-all duration-200 transform hover:scale-[1.02] disabled:bg-gray-400 disabled:cursor-not-allowed disabled:transform-none text-base sm:text-lg font-medium shadow-lg"
                ...
                <motion.button 
                  className="px-6 py-3 font-medium transition-all duration-200 border-2 sm:px-8 sm:py-4 rounded-xl sm:w-auto border-accent text-accent hover:bg-accent hover:text-white"
              ...
              <div className="flex flex-wrap items-center justify-center mt-3 space-x-4 text-xs sm:mt-4 sm:space-x-6 sm:text-sm text-content">
