...
const Hero: React.FC = () => {
  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden bg-gradient-to-br from-secondary via-secondary/95 to-accent/5">
      ...
      <div className="relative z-10 flex flex-col min-h-screen px-4 py-8 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col flex-1 lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
          ...
          <motion.div 
            className="flex flex-col justify-center order-2 pt-6 text-center lg:order-1 lg:text-left lg:pt-0"
